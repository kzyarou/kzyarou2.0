  ...
  return (
    <article className="bg-abyss text-cream min-h-screen">
      ...
      <section className="border-y border-forest bg-deep">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-2 md:grid-cols-4 divide-x divide-forest">
          {[
          {
            l: 'Role',
            v: project.role
          ...
          <div key={i} className="py-8 px-4 md:px-8 first:pl-0">
              ...
              <div className="font-serif text-lg md:text-xl text-cream font-light">
                {item.v}
              </div>
            </div>
          )}
