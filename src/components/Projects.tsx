...
function ProjectCard({ p, index }: {p: Project;index: number;}) {
  ...
  return (
    <Link
      to={`/projects/${p.slug}`}
      className="group relative block h-full w-[88vw] md:w-[72vw] lg:w-[64vw] xl:w-[58vw] shrink-0 mr-6 md:mr-8">
      ...
      <div
        ...
        className="h-full bg-graphite border border-hairline p-8 md:p-14 flex flex-col relative overflow-hidden transition-colors duration-500 group-hover:border-ember/60">
        ...
        {/* Ghost numeral */}
        <div
          className="absolute -top-8 -right-4 md:-top-16 md:-right-8 font-display text-[36vw] md:text-[22vw] leading-[0.8] select-none pointer-events-none"
          style={{
            color: 'transparent',
        ...
        <div className="absolute -top-8 -right-4 md:-top-16 md:-right-8 font-display text-[36vw] md:text-[22vw] leading-[0.8] select-none pointer-events-none text-ember/10 italic transition-opacity duration-500 opacity-0 group-hover:opacity-100">
          {p.num}
        </div>

        {/* Top-left: view project indicator */}
        <div className="absolute top-6 left-6 md:top-10 md:left-12 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 min-h-0 mt-6">
          <div className="lg:col-span-5 flex flex-col min-h-0">
            <div className="font-mono text-xs text-ember tracking-[0.3em] mb-4">
              PROJECT · {p.num}
            </div>
            <h3 className="font-display font-normal text-5xl md:text-7xl leading-[0.9] text-bone mb-6 group-hover:text-ember-glow transition-colors duration-500">
              {p.name}
            </h3>
            ...
            <p className="text-muted leading-relaxed text-sm md:text-base font-light max-w-md line-clamp-5">
              {p.description}
            </p>
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 min-h-0 overflow-hidden">
            <div>
              <div className="font-mono text-[10px] tracking-widest uppercase text-muted/60 mb-3">
                Key Features
              </div>
              <ul className="space-y-2">
                ...
                <li
                  key={i}
                  className="flex gap-3 text-bone text-base md:text-lg font-display leading-snug">
                  
                    <span className="font-mono text-ember text-xs mt-2 shrink-0">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span
                  key={t}
                  className="font-mono text-xs px-3 py-1.5 bg-panel border border-hairline text-bone">
    ...
    <section id="work" className="relative bg-obsidian">
      ...
      <div
        ...
        <div
          ...
          <div className="max-w-[1600px] mx-auto px-4 md:px-12 pt-28 md:pt-40 pb-6 md:pb-8 w-full shrink-0">
            <SectionHeader
              number="02"
              label="Selected Work"
              title={
          ...
          <div className="relative pb-6 md:pb-8 px-4 md:px-12 shrink-0">
